...
const ModalPatients = ({ toggle, setToggle }) => {
  return (
    <>
        {/* <!-- Edit user modal --> */}
        <div id="editPatientModal" tabindex="-1" aria-hidden="true" className={`${!toggle && 'hidden'} fixed top-0 left-0 right-0 z-50 items-center justify-center w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full`}>
