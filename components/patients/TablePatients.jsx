        ...
        <div className='px-1 md:px-16 lg:px-20'>
            <div className="flex items-center rounded-lg justify-between flex-column md:flex-row flex-wrap space-y-4 md:space-y-0 py-4 bg-white dark:bg-gray-900 mb-1">
                ...
                <div class="relative ml-3">
                    ...
                    <input type="text" id="table-search-users" class="block p-1 ps-10 text-sm w-60 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search" />
                </div>
            </div>
